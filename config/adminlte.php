...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'header' => 'НАСТРОЙКА ПРЕВОДОВ',
            'can'    => 'permissions',
            'model' => 'locales_control'
        ],
        [
            'text' => 'Список языков',
            'url'  => 'admin/locale',
        ...
        [
            'text' => 'Создание языка перевода',
            'url'  => 'admin/locale/create',
            'icon' => 'fas fa-fw fa-list',
            'can'    => 'permissions',
            'model' => 'locales_control'
        ],
        ...
        [
            'header' => 'НАСТРОЙКА ПОЛЬЗОВАТЕЛЕЙ',
            'can'    => 'permissions',
            'model' => 'users_control'
        ],
        [
        ...
        [
            ...
            'icon' => 'fas fa fa-list',
            'can'    => 'permissions',
            'model' => 'company_control'

        ],
        [
            'text' => 'Создание компаний',
